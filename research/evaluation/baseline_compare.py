"""
baseline_compare.py  v9 Research (Phase6-3: 評価層)
=====================================================
...
【比較対象指標】
  ...
  calmar_ratio / time_underwater / sortino_ratio（参考）
"""
...
_METRIC_DIRECTION = {
    ...
    # max_drawdownは0以下の符号付き値(例: -0.03 = -3%)で格納される。
    # 0に近い(=less negative=数値として大きい)方が良い状態のため higher_better とする。
    # 例: research=-0.02, baseline=-0.03 の場合、diff=+0.01(改善)と正しく判定される。
    "max_drawdown":    "higher_better",
    "win_rate":        "higher_better",
    "risk_reward":     "higher_better",
